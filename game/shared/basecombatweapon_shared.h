...
public:
	...
	virtual void			WeaponIdle(void);	// 313					// called when no buttons pressed
	virtual void			HandleFireOnEmpty(); // 314					// Called when they have the attack button down
	// but they are out of ammo. The default implementation
	// either reloads, switches weapons, or plays an empty sound.
#ifdef CLIENT_DLL // 315
...
public:
	...
	int m_iPrimaryReserveAmmoCount; // 0x15C8
	int m_iSecondaryReserveAmmoCount;
